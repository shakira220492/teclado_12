...
var previous_videoOrderPosition_1 = "";
var next_videoOrderPosition_1 = "";
...
//    alert("15");getArtistInfo(); // PaypalBundle

    storeHistory(); // HistoryBundle ->storeHistory.html.twig
    storeDatamining(); // DataminingBundle ->storeDatamining.html.twig


    
//    alert("el video se acabó... "+listId+" ... "+videoOrderPosition);
...
//        videoOrderPosition
        ...
        get_anotherVideo(kindOfList, listId, videoOrderPosition); // PlayBannerBundle->index.html.twig
